...
- Classe : Toutes les classes doivent hériter de `ModEntity<VotreClasse>` ainsi que de `IMCheckpoint`
...
Il s'agit d'un système en cours d'expérimentation provenant de modkit (développeur du module: Aarnow)
